...
export default function HeadingSection() {
  return (
    <>
      <Heading image="/images/wonjin-intro-cover.png" imageHeight={20}>
        <Container textAlign="left" padding="2rem 2rem 3.438rem 2rem">
          <Text color="blue" fontSize={2.25} inlineBlock>
            물류의 새로운 길,
          </Text>
          <Text color="blue" fontSize={2.25} fontWeight="bold" inlineBlock>
            지금 원진물류를 만나보세요.
          </Text>
        </Container>
      </Heading>
